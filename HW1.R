...
0.7+(0.2+0.1)==1
(0.7+0.1)+0.2==1
#1 (e) 0.7, 0.2, 0.1 are binary floating-point numbers. For the partial sum of 0.7 + 0.2, we lost the last two digis of 0.2 when we align the exponents. Then we add 0.1 to the partial sum and we lost three digits from 0.1 when we align the exponents. The final result is not exactly equal to 1.
...
#4
oringp=read.table(file="https://github.com/tulane-math7360/Math-7360-Ophelia-Li/blob/master/oringp.dat", 
...
print(Cholesky)
#6 (d)
system.time(prod(diag(Cholesky))^2)